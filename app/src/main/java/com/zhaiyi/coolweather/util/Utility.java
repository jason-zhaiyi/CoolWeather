...
public class Utility {
    ...
    /**
     * Parse returned JSON data and save it locally.
     */
    ...
    /**
     * Parse and handle the Province data returned from server
     */
    ...
    /**
     * Parse and handle the City data returned from server
     */
    ...
    /**
     * Parse and handle the County data returned from server
     */
